    ...
    <main class="main-container home-section">
        <section id="home">
            <div class="landing-page-details">
                ...
                <h2 class="big-title">I'm <span class="my-name">{{ $user->name ?? 'yogaviveka' }}</span></h2>
                <h3 class="medium-title"><em>{{ $user->title ?? 'yogaviveka' }} @ <a class="pink"
                            href="{{ $user->github_url ?? '#' }}">{{ $user->username ?? 'yogaviveka' }}</a></em></h3>
            </div>
            <div class="art-me">
                @if($user && $user->hero_gift)
                    <img src="{{ asset('img/me-icon.png' . $user->hero_gift) }}">
                @endif
            </div>
        ...
        <section class="projects" id="select-projects">
            ...
            <p class="section-description">
                ...
                You can find more on <a class="hyperlink" href="https://github.com/xannydayo">GitHub</a>.
            </p>
