...
<body>
    <header class="header">
        <a href="/" class="header-logo">{{ $user->username ?? 'Guest' }}</a>
        <nav class="nav">
    ...
    <footer class="footer-container">
        <div class="footer">
            <div class="footer-column">
                <a href="/" class="footer-logo">{{ $user->username ?? 'Guest' }}</a>
                <div class="socials">
                    <ul>
                ...
                <span class="copyright"><i class="fa-regular fa-copyright"></i> {{ $user->name ?? 'Anonymous' }} -
                    {{ now()->format('Y') }}</span>
            </div>
            <div class="footer-column">
            ...
            <div class="footer-column">
                ...
                <a href="mailto:{{ $user->email ?? 'contact@example.com' }}" class="footer-button">
